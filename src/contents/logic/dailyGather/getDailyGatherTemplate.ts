      ...
      <tbody>
        <tr style="height: 21px;">
          <td rowspan="1" colspan="2"
            style="padding: 2px 3px; border: 1px solid rgb(0, 0, 0); vertical-align: bottom; background-color: rgb(214 237 247); text-align: center;">
            <span style="font-size: 10pt; font-family: Arial; color: rgb(30, 30, 35);">특이사항
            </span>
          </td>
          <td
            style="padding: 2px 3px; border-width: 1px; border-style: solid; border-color: rgb(0, 0, 0) rgb(0, 0, 0) rgb(0, 0, 0) rgb(204, 204, 204); vertical-align: bottom; background-color: rgb(214 237 247); text-align: center;">
